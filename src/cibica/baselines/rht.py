...
Original method:
    ...
    Randomized Hough Transform (RHT). Pattern Recognition Letters, 11(5),
    331-338. https://doi.org/10.1016/0167-8655(90)90042-Z
...
def rht(edgels, num_iterations=1000, threshold=5):
    ...
    for iteration in range(num_iterations):
        ...
        distances_to_center = np.sqrt(
            (edgels[:, 0] - center_x) ** 2 + (edgels[:, 1] - center_y) ** 2
        )
